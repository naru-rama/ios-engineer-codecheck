...
- [x] 初級:バグを修正
- [x] 初級:FatVCの回避
- [x] 中級:プログラム構造をリファクタリング
- [x] 中級:アーキテクチャを適用→MVVMを使用
- [ ] 中級:テストを追加
- [x] ボーナス:UIをブラッシュアップ→検索結果に画像・Star数などを表示
- [x] ボーナス:新機能を追加→検索結果のソート機能を追加、無限スクロール機能を追加

## 動作イメージ
![動作イメージ](README_Images/Version1.9.gif)
